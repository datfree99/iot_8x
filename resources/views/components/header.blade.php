                    ...
                    <div class="flex-col hide-for-medium flex-right">
                        <ul class="nav top-bar-nav nav-right nav-small nav-divided">
                            <li id="menu-item-7330-en" class="lang-item lang-item-360 lang-item-en lang-item-first menu-item menu-item-type-custom menu-item-object-custom menu-item-7330-en menu-item-design-default">
                                @if(App::getLocale() == 'vi')
                                    <a href="{{route('change-language', ['lang' => 'en'])}}" hreflang="en-GB" lang="en-GB" class="nav-top-link">
                                ...
                                @else
                                    <a href="{{route('change-language', ['lang' => 'vi'])}}" hreflang="vi" lang="vi" class="nav-top-link">
                ...
                <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
                    ...
                    <div id="logo" class="flex-col logo">
                        ...
                        <a href="{{route('home')}}" title="{{config('core.app_name')}}" rel="home">
                            <img width="1" height="1" src="/images/logo_iotsmart.png" class="header_logo header-logo" alt="Iot smart">
                            <img width="1" height="1" src="/images/logo_iotsmart.png" class="header-logo-dark" alt="Iot smart">
                        </a>
                    </div>
                                            ...
                                            <div class="flex-row relative">
                                                <div class="flex-col flex-grow">
                                                    <label class="screen-reader-text"
                                                           for="woocommerce-product-search-field-0">{{trans('label.search')}}:</label>
                                                    <input type="search" id="woocommerce-product-search-field-0"
                                                           class="search-field mb-0" placeholder="{{trans('label.search')}}..." value="" name="s">
