                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{$category->id}}"  @if($category->id == old('category')) selected @endif>{{$category->name_vi}}</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('description_en', old('description_en'), ['class' => 'form-control', 'placeholder' => 'Nhập mô tả...', 'rows' => 3]) !!}
        ...
        <div class="card-box mb-30">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea name="contents" id="content-vi" class="form-control" rows="20" placeholder="Nhập mô tả">{!! old('contents') !!}</textarea>
                </div>
            </div>
        </div>
        <div class="card-box mb-30">
            <div class="card-body">
               <div class="form-group">
                   ...
                   <textarea name="contents_en" id="content-en" class="form-control" rows="20" placeholder="Nhập mô tả">{!! old('content_en') !!}</textarea>
               </div>
            </div>
        </div>
